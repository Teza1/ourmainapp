...
export default class Search {
    ...
    <div class="list-group-item active"><strong>Search Results</strong> (${posts.length > 1 ? `${posts.length} items found` : '1 item found'
                })</div>
    ${posts
                    .map((post) => {
        ...
        <img class="avatar-tiny" src="${post.user.avatar}"> <strong>${post.title
                            }</strong>
        <span class="text-muted small">by ${post.user.username} on ${postDate.getMonth() + 1
